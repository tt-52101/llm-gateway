export default {
  ...
  validation: {
    ...
    expertRouting: {
     layer1PreprocessingTitle: 'Request Cleaning',
     layer1PreprocessingTooltip: 'Remove noisy content from requests to improve routing accuracy',
     decisionStrategy: 'Decision Strategy',
     routingMode: 'Routing Mode',
     modeLLM: 'LLM Judge (Default)',
     modeSemantic: 'Semantic Router (L1)',
     modeHybrid: 'Hybrid Mode (L1 + L3)',
    semanticConfig: 'Semantic Routing Config',
    semanticModel: 'Embedding Model',
    threshold: 'Similarity Threshold',
    thresholdHint: 'Cosine similarity threshold (0-1), higher is stricter',
    margin: 'Margin',
    marginHint: 'Minimum difference between Top1 and Top2 scores',
    llmClassifierConfig: 'LLM Classifier Config',
    semanticUtterances: 'Semantic Examples (Utterances)',
    semanticUtterancesPlaceholder: 'Enter typical user instructions for this category, one per line...',
    semanticUtterancesHint: 'These examples will be vectorized for similarity matching with user input',
    selectExpertTemplate: 'Select Expert Template',
    selectTemplateTitle: 'Select Preset Template',
    selectTemplateDesc: 'Select from preset intent types to quickly create an expert; or start from scratch.',
    customTemplate: 'Custom Expert',
    customTemplateDesc: 'Create a new expert configuration from scratch',
    examples: 'Examples',
    ...
    fallbackDesc: 'When all steps in expert routing (semantic matching, LLM judge) fail to match or execute, this fallback model will be used.',
    ...
    expertCriteria: 'Classification Criteria',
    expertCriteriaPlaceholder: 'Define what this expert should/should not handle. Used by the classifier to distinguish experts (not sent upstream)...',
    expertCriteriaHint: 'Used only as classification criteria (for LLM Judge), and will NOT be sent as the upstream model system prompt.',
  ...
  performanceMonitoring: {
    ...
    subtitle: 'View the last 7 days of model performance data, supporting analysis by provider and model dimensions',
    last7Days: 'Last 7 Days',
    filters: {
      provider: 'Provider',
      model: 'Model',
    ...
    charts: {
      ...
      modelComparison: 'Model "{model}" Cross-Provider Comparison',
      topModels: 'Top Models by Requests',
      modelRanking: '{provider} Model Ranking',
      overallPerformance: 'Overall Performance Ranking',
    },
    table: {
    ...
    empty: {
      ...
      noResults: 'No data for selected filters',
    },
  },
  healthMonitoring: {
